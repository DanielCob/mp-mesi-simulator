# ============================================================================
# Producto Punto Paralelo - PE0 (CÓDIGO GENÉRICO REUTILIZABLE)
# ============================================================================
...
#   [2] = RESULTS_ADDR
#   [3] = FLAGS_ADDR
#   [8+0*2] = PE0_START_INDEX
#   [9+0*2] = PE0_SEGMENT_SIZE
# ============================================================================
...
# Cargar start_index para PE0 (addr 8)
MOV R4, 8.0
LOAD R1, [R4]        # R1 = start_index (índice, no dirección)

# Cargar segment_size para PE0 (addr 9)
MOV R4, 9.0
